...
$ERR_EMPTY_LOG_PRE = fn () => \NeoslugerLocale\localize([
	"EN" => "Log for",
	"ES" => "¡El historial de",
]);
$ERR_EMPTY_LOG_POST = fn () => \NeoslugerLocale\localize([
	"EN" => "is empty!",
	"ES" => "está vacío!",
]);


$ERR_INVALID_HANDLE_LEN = fn () => \NeoslugerLocale\localize([
...
$ERR_UNWRAP = fn () => \NeoslugerLocale\localize([
...
$ERR_URL_NOT_INSERTED = fn () => \NeoslugerLocale\localize([
