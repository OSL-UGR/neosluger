...
final class URLInteractorTest extends \PHPUnit\Framework\TestCase
{
	...
	private const IP = \NslSettings\ALLOWED_IPS[0];
	...
	public function test_registering_a_url_from_invalid_ip_return_an_error (): void
	{
		global $ERR_ILLEGAL_IP;
		$result = $this->interactor->register_new_url("", "", "1.1.1.1");

		$this->assertFalse($result->ok());
		$this->assertEquals($ERR_ILLEGAL_IP(), $result->first_error());
	}
	...
	public function test_registering_a_url_witout_destination_return_an_error (): void
	{
		...
		$result = $this->interactor->register_new_url("", "", URLInteractorTest::IP);
	...
	public function test_registering_a_invalid_url_returns_an_error (): void
	{
		...
		$result = $this->interactor->register_new_url("invalid-url", "", URLInteractorTest::IP);
	...
	public function test_registering_a_url_with_an_excesively_short_handle_return_an_error (): void
	{
		...
		$result = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, str_repeat("s", \NslSettings\MIN_HANDLE_LEN-1), URLInteractorTest::IP);
	...
	{
		global $ERR_ILLEGAL_HANDLE_LEN;
		$result = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, str_repeat("l", \NslSettings\MAX_HANDLE_LEN+1), URLInteractorTest::IP);
	...
	{
		$this->assertTrue($this->interactor->register_new_url(URLInteractorTest::DESTINATION, "", URLInteractorTest::IP)->ok());
		$this->assertTrue($this->interactor->register_new_url(URLInteractorTest::DESTINATION, "", URLInteractorTest::IP)->ok());
	}
	...
	public function test_a_url_cannnot_be_registered_twice_with_same_handle (): void
	{
		...
		$this->interactor->register_new_url(URLInteractorTest::DESTINATION, URLInteractorTest::HANDLE, URLInteractorTest::IP);

		$result1 = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, URLInteractorTest::HANDLE, URLInteractorTest::IP);
		$result2 = $this->interactor->register_new_url("https://osl.ugr.es", URLInteractorTest::HANDLE, URLInteractorTest::IP);
	...
	{
		$url = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, URLInteractorTest::HANDLE, URLInteractorTest::IP)->unwrap();
	...
	{
		$url1 = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, URLInteractorTest::HANDLE, URLInteractorTest::IP)->unwrap();
		$url2 = $this->interactor->register_new_url("https://osl.ugr.es", "other-test", URLInteractorTest::IP)->unwrap();
	...
	{
		$url = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, "", URLInteractorTest::IP)->unwrap();
	...
	{
		$url1 = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, "", URLInteractorTest::IP)->unwrap();
		$url2 = $this->interactor->register_new_url(URLInteractorTest::DESTINATION, "", URLInteractorTest::IP)->unwrap();
