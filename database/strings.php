...
$ERR_COULDNT_LOG = fn () =>\NeoslugerLocale\localize([
	"EN" => "Could not log URL access for",
	"ES" => "¡No se pudo registrar el acceso al enlace",
]);


$ERR_COULDNT_REGISTER = fn () =>\NeoslugerLocale\localize([
	"EN" => "Could not register URL",
	"ES" => "¡No se pudo registrar el enlace",
]);


$ERR_DATABASE_OFFLINE = fn () =>\NeoslugerLocale\localize([
...
$ERR_LOG_NOT_FOUND = fn () =>\NeoslugerLocale\localize([
	"EN" => "Could not find log for URL",
	"ES" => "¡No se pudo encontrar el historial del enlace",
]);


$ERR_URL_NOT_FOUND = fn () => \NeoslugerLocale\localize([
	"EN" => "Could not find URL with hanle",
	"ES" => "¡No se pudo encontrar el enlace con nombre",
]);


$ERR_REGISTERING_FAILED_LOG_PRE = fn () =>\NeoslugerLocale\localize([
	"EN" => "Registration of logs for URL",
	"ES" => "¡El registro de un historial para el enlace",
]);
$ERR_REGISTERING_FAILED_URL_PRE = fn () =>\NeoslugerLocale\localize([
	"EN" => "Registration of URL",
	"ES" => "¡El registro del enlace",
]);
$ERR_REGISTERING_FAILED_POST = fn () =>\NeoslugerLocale\localize([
	"EN" => "failed!",
	"ES" => "falló!",
]);


$ERR_ZERO_RESULTS_LOG_PRE = fn () => \NeoslugerLocale\localize([
	"EN" => "Log lookup for URL",
	"ES" => "¡La búsqueda del historial del enlace",
]);
$ERR_ZERO_RESULTS_URL_PRE = fn () => \NeoslugerLocale\localize([
	"EN" => "URL lookup with handle",
	"ES" => "¡La búsqueda de un enlace con nombre",
]);
$ERR_ZERO_RESULTS_POST = fn () => \NeoslugerLocale\localize([
